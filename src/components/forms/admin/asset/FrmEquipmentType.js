...
import {
  ...
  PostNewEqType,
  UpdateEqType,
} from '../../../../store/slices/admin/asset/EquipmentTypeSlices';
...
const FrmEquipmentType = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      if (selectedBrand) {
        dispatch(UpdateEqType(values));
      } else {
        dispatch(PostNewEqType(values));
      }
      formik.resetForm();
  ...
  const handleRowDelete = () => {
    dispatch(DeleteEqType({ id: selectedBrand.id }));
...
export default FrmEquipmentType;
